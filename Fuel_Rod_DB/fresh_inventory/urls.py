...
from .views import ShowTable, CreateRawRod, UpdateRawRod, LoginUser, logout_user, RegistrationUser, delete_rod
...
urlpatterns = [
    ...
    path('fresh_inventory/delete_raw_rod/<slug:rod_name>/', delete_rod, name='delete'),
